    ...
    function preview(e) [
        if (e.files[0]){
            ...
            reader.onload = function(e){
                document.querySelector("#gallery-display").setAtrribute('src' , e.target.result);
            }
            ...
            <div class = "my-auto">
                ...
                <form action = "includes/gallery-helper.php" method = "POST" enctype = "multipart/form-data">
                    <div class = "form-group">
                        <img src = "Image/2.jpeg" alt = "profile pic" onclick = "triggered();" id = "gallery-display">
                    ...
                    <div class = "form-group"
                        <textarea name = "descript" id = "bio" cols = "30" rows = "10" placeholder = "descript" style = "text-align: center; "> </textarea>
                    </div>
                        <div class = "form-group">
